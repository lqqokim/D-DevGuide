        ...
        <div class="indx-slider" :class="sliderImage" style="display: block;">
          <div class="indx-slider-desc fl">
            <dl>
              ...
              <dd class="main-sub">
                실제 경영 사례에서 도출한 경영 문제와 시나리오를 기반으로 문제
                해결을 시도하고 경쟁하는 롤플레잉 형태의 경영교육 시뮬레이션
                게임입니다.
              </dd>
            </dl>
    ...
    <section class="dbs-index-service">
      <div class="document illust01">
        ...
        <dl>
          ...
          <dd>
            DEWS/UI, DEWS/J, DEWS/FD, DEWS/BD 에 대한 정보를 알고 싶으신가요?
            DEWS 개발자 문서에서 각 제품에 대한 다양한 정보를 알려드릴게요!
          </dd>
        </dl>
      ...
      <div class="document illust03">
        ...
        <dl>
          ...
          <dd>
            DBS 포럼이란 경영 학습 시뮬레이션 게임을 주제로 사용자들끼리
            토론하고 소통할 수 있는 커뮤니티입니다.
          </dd>
        </dl>
        <div class="btn-wrap mgt-20">
          <a
