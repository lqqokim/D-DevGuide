...
export default class ProductRegister extends Vue {
  ...
  productName: string = '';
  description: string = '';
  projectId: number = 0; // 이건 number 형태가 맞는 듯
  targetBranch: string = '';
  manualDocPath: string = '';
  APIDocPath: string = '';
  attachmentFilePath: string = '';

  @Product.Action('setProduct') setProductAction;
  @Product.Action('getProductList') getProductListAction;
  @Product.Getter('wholeProductList') productList!: product.Product[];
