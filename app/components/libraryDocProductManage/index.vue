...
import { IProduct, IStaff, IDocument } from '~/store/modules/document';
...
export default class LibraryDocProductManage extends Vue
  implements IProductManage<IProduct> {
  @Common.Action('alert') alertAction!: (payload: IAlert) => Promise<any>;
  @Doc.Action('registerProduct') registerProductAction!: (
    product: IDocument
  ) => Promise<any>;
  @Doc.Action('updateProduct') updateProductAction!: (
    product: IDocument
  ) => Promise<any>;
  ...
  created() {
    const products: IProduct[] = this.$store.state.document.products;
  ...
  async onclickSave(): Promise<any> {
    ...
    // this.initialProducts = this.$store.state.document.products.slice();
