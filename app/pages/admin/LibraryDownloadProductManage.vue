<template>
  <download-product-manage v-if="$store.state.user.user._id" />
  ...
  <!--          <dt>자료실</dt>-->
  <!--          <dd>-->
  <!--            DEWS 플랫폼에 포함된 제품들을 이용하여 개발을 진행할 때 도움이 될 수-->
  <!--            있는<br />-->
  ...
  <!--          <div class="view-top">-->
  <!--            <h2 class="tit-con-text">다운로드<span>제품관리</span></h2>-->
  <!--            <div class="pst-rbtn">-->
  ...
  <!--                          type="text"-->
  <!--                          class="inp-base w-100p"-->
  <!--                          placeholder="DEWS Front-end Desinger"-->
  <!--                        />-->
  <!--                      </td>-->
  <!--                    </tr>-->
  <!--                  </tbody>-->
  ...
  <!--                <p>-->
  <!--                  직원 사용자 중 스태프로 추가된 사람은 모든 항목에 대한-->
  <!--                  수정/삭제 권한을 가집니다.-->
  <!--                </p>-->
  <!--              </div>-->
...
import DownloadProductManage from '@/components/libraryDownloadProductManage/index.vue';

@Component({
  layout: 'default',
  components: {
    DownloadProductManage,
  },
  async fetch({ store }) {
    try {
