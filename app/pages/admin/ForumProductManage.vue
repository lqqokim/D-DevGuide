<template>
  <forum-product-manage v-if="$store.state.user.user._id" />
  ...
  <!--                <p>-->
  <!--                  직원 사용자 중 스태프로 추가된 사람에 한해 질문의 완료 처리-->
  <!--                  가능하며 작성한 답변에-->
  <!--                  <span class="badge-staff">STAFF</span> 배지가 출력됩니다.-->
  <!--                </p>-->
  <!--              </div>-->
...
import ForumProductManage from '~/components/forumProductManage/index.vue';
